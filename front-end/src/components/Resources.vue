...
<template>
  <div>
    <p></p>
    <img alt="Resources" src="https://i.ibb.co/gvJ15Ln/resources.png" height="25">
    <p></p>

    <p>For more information about calories and other nutritional information about typical food items, 
    ...
    <a
      ...
      <button>Canadian Food Guide</button>
    </a>
